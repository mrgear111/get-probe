                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                        <div className="md:col-span-1">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-8 h-8 flex items-center justify-center">
                                    <img src="/probe.png" alt="Probe" className="w-8 h-8" />
                                </div>
                                <span className="font-bold text-xl text-white">Probe</span>
                            </div>
                            <p className="text-zinc-500 text-sm leading-relaxed mb-4">
                                The browser that learns how you build.
                            </p>
                            <div className="flex gap-4">
                                <a href="https://github.com/probe-hq" className="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:border-zinc-700 transition-colors group">
                                ...
                                <a href="https://x.com/probebrowser" className="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:border-zinc-700 transition-colors group">
                                    <svg className="w-4 h-4 text-zinc-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="https://www.linkedin.com/company/probebrowser" className="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:border-zinc-700 transition-colors group">
                                    <svg className="w-4 h-4 text-zinc-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="ml-50">
                            ...
                            <ul className="space-y-3">
                                ...
                                <li><a href="#" className="text-zinc-500 hover:text-white transition-colors text-sm">Roadmap</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="ml-50">
                            ...
                            <ul className="space-y-3">
                                <li><a href="#" className="text-zinc-500 hover:text-white transition-colors text-sm">Documentation</a></li>
                                <li><a href="#" className="text-zinc-500 hover:text-white transition-colors text-sm">Blog</a></li>
                                <li><a href="#" className="text-zinc-500 hover:text-white transition-colors text-sm">Templates</a></li>
                                <li><a href="#" className="text-zinc-500 hover:text-white transition-colors text-sm">Community</a></li>
                            </ul>
                        </div>
                    </div>
                    {/* Bottom Bar */}
                    <div className="pt-16 flex flex-col md:flex-row items-center justify-between gap-4 ml-100 align-middle">
                        <p className="text-zinc-500 text-sm">
                            © 2025 Probe. All rights reserved.
                        </p>
                    </div>
                </footer>
            </div>
